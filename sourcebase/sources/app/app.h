...
/*****************************************************************************/
/* define timer */
#define GW_WEB_MQTT_TRY_CONNECT_INTERVAL				  (5000)
#define GW_WEB_MQTT_TRY_CONNECT_AFTER_DISCONNECT_INTERVAL (20000)

/* define signal */
enum {
	GW_CLOUD_MQTT_TRY_CONNECT_REQ = AK_USER_DEFINE_SIG,
	GW_CLOUD_DATA_COMMUNICATION,
	GW_CLOUD_SET_MQTT_CONFIG_REQ,
	GW_CLOUD_GET_MQTT_CONFIG_REQ,
	GW_CLOUD_GET_CONFIG_RES,
	GW_CLOUD_SET_CONFIG_RES,
	GW_CLOUD_ALARM_PUBLISH,
